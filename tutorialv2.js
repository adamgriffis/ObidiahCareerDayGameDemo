...
function explodePlayer(playerNode){
	...
	playerNode.addSprite("explosion",{animation: playerAnimation["explode"], width: 100, height: 100})
	playerHit = true;
}
...
$(function(){
	...
	playerAnimation["idle"]		= new $.gQ.Animation({imageURL: "knight.png"});
	playerAnimation["explode"]	= new $.gQ.Animation({imageURL: "knight_explode.png", numberOfFrame: 4, delta: 100, rate: 60, type: $.gQ.ANIMATION_VERTICAL});
